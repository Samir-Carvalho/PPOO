...
public class Jogo {
    ...
    private void criarPersonagens(){
        Personagem lobisomen, mumia, vampiro, zumbi;
    ...
    */
    private void imprimirMsgApresentacao(){
        ...
        if(personagemAtual.lobisomen != null){
            System.out.println(personagemAtual.lobisomen.getDescricao());   
        }
        if(personagemAtual.mumia != null){
            System.out.println(personagemAtual.mumia.getDescricao());   
        }
        if(personagemAtual.vampiro != null){
            System.out.println(personagemAtual.vampiro.getDescricao());   
        }
        if(personagemAtual.zumbi != null){
            System.out.println(personagemAtual.zumbi.getDescricao());   
        }
        System.out.println();
    }
    /**
    ...
    private void imprimirAjuda() {
        ...
        System.out.println("\ttransformar \tlutar \tsair \tajuda");
    }
    /** 
    ...
    private boolean lutar() {
        ...
        diferenca = (pesoAtaque*(personagemAtual.forcaAtaque-forcaAtaqueAdversario)+pesoDefesa*(personagemAtual.forcaDefesa-forcaDefesaAdversario))/10;
        if(diferenca >= 0){
